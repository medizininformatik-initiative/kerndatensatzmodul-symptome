# Änderungshistorie - MII IG Symptom v2027.0.0-ballot
...
* Abhängigkeiten für die Ballot-Linie 2027 angehoben: Meta-Modul `2026.0.0` → `2027.0.0-ballot`, Deutsche Basisprofile `1.5.4` → `1.6.0`, `hl7.fhir.eu.base` `0.1.0` → `2.0.0`.
