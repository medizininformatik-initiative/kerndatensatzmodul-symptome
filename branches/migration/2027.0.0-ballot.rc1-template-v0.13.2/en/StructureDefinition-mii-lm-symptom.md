...
## Logical Model: MII LM Symptom 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-symptom/StructureDefinition/mii-lm-symptom | *Version*:2027.0.0-ballot.rc1 |
| Active as of 2026-08-31 | *Computable Name*:MII_LM_Symptom |
...
Other representations of profile: [CSV](../StructureDefinition-mii-lm-symptom.csv), [Excel](../StructureDefinition-mii-lm-symptom.xlsx) 
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-08-31T21:24:22+00:00",
