# Versionierung - MII IG Symptom v2027.0.0-ballot.rc1
...
Alle veröffentlichten FHIR-Artefakte im Paket tragen dieselbe Version wie der Leitfaden und sein Paket. Ein Artefakt kann daher beim Release eine neue Version erhalten, obwohl es selbst unverändert geblieben ist. Die maschinenlesbaren Metadaten (Versionsalgorithmus, Versionierungs-Politik, Paketquelle und Manifest-Parameter) deklariert die [ImplementationGuide-Ressource](ImplementationGuide-mii-ig-symptom.md) dieses Moduls.
