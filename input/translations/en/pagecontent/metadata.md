...
> following the per-entry procedure in [`docs/optional-pages.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-symptome-ig-inoffiziell/blob/main/docs/optional-pages.md) of this
> repository. A release must not ship with this banner (convention check M9).
{: .ig-highlight .ig-highlight-grey}

### Metadata Overview

This page documents the computable metadata of the **Symptom** module.
...
| [Resource Approval Date](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-resource-approvalDate.html) | Artifact lifecycle; publishing; governance | `ImplementationGuide.extension` (`2026-08-31`) | Records the date on which the publisher officially approved the content for use. |
...
> [`input/fsh/rulesets/crmi.fsh`](https://github.com/forschungsgruppe-digital-health/mii-kds-symptome-ig-inoffiziell/blob/main/input/fsh/rulesets/crmi.fsh) — add the corresponding rows here.]
{: .ig-highlight .ig-highlight-grey}
...
`YYYY.MINOR.PATCH[-label]`, currently `2026.0.0-rc.1`. The calendar year
...
| --- | --- | --- | --- |
| F1 | RDA-F1-01M | Metadata is identified by a persistent identifier | Canonical `url` values, the package id `de.medizininformatikinitiative.kerndatensatz.symptom`, the package version and `package-source`. Persistence depends on publication governance. |
