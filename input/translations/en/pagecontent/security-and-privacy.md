...
<!-- English rendering of input/pagecontent/security-and-privacy.md.
     ...
     optional: this module has no aspects of its own and adopts the default
     text in the section (migration decision 5.4b, 2026-08-31; the scaffold's
     illustrative Person example was removed per convention check M11).
     German source: input/pagecontent/security-and-privacy.md —
