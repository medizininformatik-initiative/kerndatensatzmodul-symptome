...
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-symptome/blob/main/docs/recipes/add-a-profile.md) in this repository, and the MII naming
