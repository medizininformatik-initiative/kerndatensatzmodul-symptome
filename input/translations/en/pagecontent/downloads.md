...
The page [MII ImplementationGuide Resource](ImplementationGuide-mii-ig-symptom.html)
describes this resource with its dependency table, cross-version analysis and
copyright notes.
