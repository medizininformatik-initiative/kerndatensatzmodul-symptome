...
* **[Datasets and Descriptions](logical-models.html)** — the module's data
  ...
  *Artifacts → Logical Models*; neither Artifacts-Summary anchor is usable as
  a link target — see
  [`docs/page-structure.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-symptome-ig-inoffiziell/blob/main/docs/page-structure.md) in this repository.)
