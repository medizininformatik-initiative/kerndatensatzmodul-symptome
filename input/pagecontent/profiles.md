...
Diese Seite listet die FHIR-Profile des Moduls **Symptom**. Als
...
[`docs/recipes/add-a-profile.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-symptome-ig-inoffiziell/blob/main/docs/recipes/add-a-profile.md) in diesem Repository sowie die
