...
> nach der Schritt-für-Schritt-Anleitung in [`docs/optional-pages.md`](https://github.com/forschungsgruppe-digital-health/mii-kds-symptome-ig-inoffiziell/blob/main/docs/optional-pages.md) dieses
...
**Symptom**. Sie existieren, damit die Artefakte dieses Leitfadens
...
[`sushi-config.yaml`](https://github.com/forschungsgruppe-digital-health/mii-kds-symptome-ig-inoffiziell/blob/main/sushi-config.yaml)
...
| [Resource Approval Date](http://hl7.org/fhir/extensions/5.3.0/StructureDefinition-resource-approvalDate.html) | Lebenszyklus; Veröffentlichung; Governance | `ImplementationGuide.extension` (`2026-08-31`) | Hält fest, wann der Herausgeber den Inhalt offiziell zur Nutzung freigegeben hat. |
...
> ein gemeinsames `RuleSet` in [`input/fsh/rulesets/crmi.fsh`](https://github.com/forschungsgruppe-digital-health/mii-kds-symptome-ig-inoffiziell/blob/main/input/fsh/rulesets/crmi.fsh) —, ergänzen Sie die
...
numerischen Form `JJJJ.MINOR.PATCH[-label]`, derzeit `2026.0.0-rc.1`. Das
...
| --- | --- | --- | --- |
| F1 | RDA-F1-01M | Metadaten sind über einen persistenten Identifikator identifiziert | Kanonische `url`-Werte, die Paket-Id `de.medizininformatikinitiative.kerndatensatz.symptom`, die Paketversion und `package-source`. Die Persistenz hängt von der Veröffentlichungs-Governance ab. |
