...
| Placeholder | Where |
|---|---|
| `2026.0.0-rc.1` | `version.fsh`, `meta-profile.fsh`, `cps-rules.fsh` |
| `symptom` | `version.fsh` (package id + canonical of the package source) |
| `2026` | `version.fsh` (`resource-effectivePeriod.start`) |
| `2022` | `crmi.fsh` (`artifact-copyrightLabel`) |
...
| `C4876` | passed in at the call site: `insert CRMIArtifactTopic(…, C4876)` |
