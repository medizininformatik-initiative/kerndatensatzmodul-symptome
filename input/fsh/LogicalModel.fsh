...
* Condition 0..* BackboneElement "Im Sinne einer FHIR Condition: klinische Zustände, Probleme, Diagnosen oder andere Ereignisse und Situationen. Conditions können als Beschreibung von Krankheiten von Health Professionals dokumentiert sein. Conditions können im Rahmen einer Anamnese vom Patienten selber geäußert werden (Symptom)."
  ...
  * KlinischRelevanterZeitraum 0..1 BackboneElement "Zeitspanne des Vorhandenseins des Symptoms, der Erkrankung, der Diagnose, der Disposition, des Phänotyps"
    * Zeitraum 0..1 Period "Klinisch relevanter Zeitraum als Zeitintervall mit von/am und bis."
      * start 0..1 dateTime "Startzeitpunkt: Zeitpunkt des Beginns des Symptoms, der Erkrankung, der Diagnose, der Disposition, des Phänotyps"
      * end 0..1 dateTime " Endzeitpunkt: Zeitpunkt des Verschwindens des Symptoms, der Erkrankung, der Diagnose, der Disposition, des Phänotyps"
...
* Observation 0..* BackboneElement "Observation i. S. einer FHIR Observation: Messungen oder Zuweisungen zu einem Patienten. Die meisten Beobachtungen sind einfache Entity/Value Paare, sie können aber auch komplex hierarchisch aufgebaut sein."
  ...
  * Zeitspanne 0..1 Period "Klinisch relevante Zeitpunkte/Zeitspanne"
    * start 0..1 dateTime "Klinisch relevanter (Start-)Zeitpunkt einer Observation"
    * end 0..1 dateTime "Klinisch relevanter Endzeitpunkt einer Observation"
...
* Condition -> "Condition"
  ...
  * KlinischRelevanterZeitraum -> "Conditon.abatement[x]"
    ...
    * Zeitraum -> "Conditon.abatementPeriod"
      * start -> "Conditon.onsetPeriod.start"
      * end -> "Conditon.onsetPeriod.end"
      * start -> "Conditon.abatementPeriod.start"
      * end -> "Conditon.abatementPeriod.end"
