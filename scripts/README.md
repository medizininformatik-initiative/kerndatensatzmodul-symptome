...
| `language-model-check.sh` | Fails the build when prose contradicts this module's German-default / English-translation language model (DE-first) | `convention-check.yml` |
